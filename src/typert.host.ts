      ...
      members: [
        {
          ...
          summary: 'Create a read-only child branch.',
          jsDoc: '/** Create a read-only child branch. */',
        },
        {
          kind: 'method',
          name: 'continueBranch',
          signature: 'continueBranch(request: ContinueBranchRequest): Promise<BranchCommandResult>',
          summary: 'Append one read-only branch turn.',
          jsDoc: '/** Append one read-only branch turn. */',
        },
        {
          kind: 'method',
          name: 'deleteBranch',
